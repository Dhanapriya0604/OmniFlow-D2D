...
def compute_insights(forecast, inventory, production, logistics):
    ...
    risk_products = (
        inventory.loc[
            inventory["stock_status"].str.contains("Critical|Reorder", na=False),
            "product_id"
        ].tolist()
...
def decision_intelligence_page():
    ...
    r1.write("Inventory Risk", insights["risk_products"] or "None")
    r2.write("Production Needed", insights["production_needed"] or "None")
    r3.write("Delay Regions", insights["delay_regions"] or "None")
